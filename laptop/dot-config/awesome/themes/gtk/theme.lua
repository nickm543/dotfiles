...
local wallpaper_bg = gears.parse_color("#000000")
-- local wallpaper_fg = theme.gtk.bg_color
local wallpaper_fg = gears.parse_color("#a80f0f")
-- local wallpaper_alt_fg = theme.gtk.selected_bg_color
local wallpaper_alt_fg = gears.parse_color("#730909")
...
-- theme.wallpaper = "~/.config/wallpaper/forest-2.jpg"
